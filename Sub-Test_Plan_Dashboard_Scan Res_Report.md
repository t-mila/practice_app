...
**Expected Result:** Scan Time, Status, Pages Scanned, Malware Found, and Links Checked are displayed and populated correctly
...
**Expected Result:** Vulnerability Scan page is displayed with scan summary and Platform Scan Results sections
...
**Expected Result:** Expanded view displays Category, Summary, and detailed Description of the vulnerability, including severity level
...
**Expected Result:** Vulnerability Scan page reloads with summary and detailed results from the selected historical scan
...
**Expected Result:** SMART Database Scan page loads successfully displaying scan summary and Platform Scan Results
...
**Expected Result:** Detailed view opens showing database table name, issue status, and malware/spam counts (fixed vs remaining)
...
**Expected Result:** Firewall & CDN page loads successfully showing the Summary tab with traffic statistics and component status
...
**Expected Result:** All statistics are displayed with non‑empty values and update correctly when the time range or metric selection changes
...
**Expected Result:** Threat details are displayed correctly, including Date Found, Category, Type, IP Address, Country, Hits/Views, Entry Page, and User Agent
...
**Expected Result:** SMART Patch page loads successfully displaying the scan summary and Scan Results sections
...
**Expected Result:** Each record displays the filename, vulnerability type, and correct patch status (Warning Only, Success, or Failed)
...
**Expected Result:** SMART Patch page reloads showing summary and Scan Results corresponding to the selected historical scan
