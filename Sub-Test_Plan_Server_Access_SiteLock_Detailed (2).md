...
## 1. Purpose
This sub-test plan defines detailed test coverage for the **Server Access** component of the SiteLock application. The objective is to verify correct configuration, validation, security, and usability of server access settings used by SiteLock services such as SMART scans and backups. citeturn2search1
...
### Out of Scope
- Execution results of scans and backups
- Hosting provider/network infrastructure
- Performance or load testing

## 3. References
- Managing Server Access — SiteLock Documentation citeturn2search1
...
**Expected Result:**
- Server Access configuration page is displayed citeturn2search1
...
**Expected Result:**
- Server Access settings page is displayed citeturn2search1
...
- No validation errors are shown citeturn2search1
...
**Expected Result:**
- System displays validation errors for missing required fields citeturn2search1
...
**Expected Result:**
- Error message is shown indicating invalid port value citeturn2search1
...
- Navigation between service tabs works correctly citeturn2search1
...
**Expected Result:**
- Only supported connection types are available for the selected service citeturn2search1
...
- Instruction to upload public key is displayed if required citeturn2search1
...
**Expected Result:**
- Updated configuration is saved and persists after page reload citeturn2search1
...
**Expected Result:**
- Website Root Directory field is not displayed or is disabled citeturn2search1
